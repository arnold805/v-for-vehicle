...
const SellVehicle = () => {
  ...
  return (
    ...
    <form className="sell-car-form" onSubmit={handleSubmit}>
      ...
      <input type="number" name="price" placeholder="price" value={formData.price} onChange={handleChange} step="1000"/>
      <input type="text" name="image"  placeholder="image URL" value={formData.image} onChange={handleChange}/>
      <input type="submit" name="add-car-listing-btn" value="Add Vehicle Listing"/>
    </form>
  </div>
);
}
